...
log_file = f"Logs/tabe_dermie_experiment_{experiment_timestamp}.txt"
...
with open(log_file, 'w', encoding='utf-8') as f:
    f.write(f"TABE DERMIE COMPARISON EXPERIMENT\n")
    f.write(f"Python Filename: {os.path.basename(__file__)}\n")
    f.write(f"Experiment Timestamp: {experiment_timestamp}\n")
    f.write(f"Experiment Design: Compare TABE performance with and without Dermie dataset\n")
...
for i, combination in enumerate(combinations):
    ...
    ### MODEL LOADING ###
    print(f"Creating TABE model for {experiment_name}...")
    ...
    ### MODEL TRAINING ###
    print(f"Training TABE model for {experiment_name}...")
...
print(f"\n=== TABE EXPERIMENT COMPLETED ===")
print(f"Results logged to: {log_file}")

with open(log_file, 'a', encoding='utf-8') as f:
    f.write("="*80 + "\n")
    f.write("TABE EXPERIMENT SUMMARY\n")
    f.write("="*80 + "\n")
    f.write("Two TABE experiments completed:\n")
