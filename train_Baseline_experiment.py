...
log_file = f"Logs/baseline_dermie_experiment_{experiment_timestamp}.txt"
...
with open(log_file, 'w', encoding='utf-8') as f:
    f.write(f"BASELINE DERMIE COMPARISON EXPERIMENT\n")
    f.write(f"Python Filename: {os.path.basename(__file__)}\n")
    f.write(f"Experiment Timestamp: {experiment_timestamp}\n")
    f.write(f"Experiment Design: Compare Baseline performance with and without Dermie dataset\n")
...
# Store results for both experiments
experiment_results = {}
...
for i, combination in enumerate(combinations):
    ...
    ### MODEL LOADING ###
    print(f"Creating Baseline model for {experiment_name}...")
    ...
    ### MODEL TRAINING ###
    print(f"Training Baseline model for {experiment_name}...")
...
# Log all results to single file
...
with open(log_file, 'a', encoding='utf-8') as f:
    f.write("="*80 + "\n")
    f.write("BASELINE EXPERIMENT SUMMARY\n")
    f.write("="*80 + "\n")
    f.write("Two Baseline experiments completed:\n")
    ...
    f.write("Check the metrics sections above for performance comparison.\n")
